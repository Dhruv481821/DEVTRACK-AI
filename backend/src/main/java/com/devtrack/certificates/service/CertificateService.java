...
/** FR-CERT-01. Same CRUD + ownership + soft-delete pattern as Notes/Calendar/Study Planner. */
@Service
public class CertificateService {
  ...
  public CertificateService(
      CertificateRepository certificateRepository, OwnershipGuard ownershipGuard) {
  ...
  @Transactional
  public CertificateResponse create(UUID userId, CreateCertificateRequest request) {
  ...
  @Transactional
  public CertificateResponse update(UUID certId, UUID userId, UpdateCertificateRequest request) {

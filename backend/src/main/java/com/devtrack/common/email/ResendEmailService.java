...
/**
 * Real Resend API integration (not a stub) — per your "never generate placeholder
 * implementations" rule. Untested against a live Resend account in this environment
 * (no network access to api.resend.com from this sandbox) — the request shape below
 * matches Resend's documented /emails endpoint, but verify against a real API key
 * before trusting it in production. See /docs/15_Deployment.md §1 step 5.
 */
@Service
...
public class ResendEmailService implements EmailService {
    ...
    private static final String FROM_ADDRESS = "DevTrack AI <noreply@devtrack.ai>"; // update once a domain is verified — 15_Deployment.md §1 step 5
    ...
    public void sendVerificationEmail(String toEmail, String verificationLink) {
        send(
                ...
                "<p>Click to verify your email:</p><p><a href=\"" + verificationLink + "\">Verify email</a></p>");
    }

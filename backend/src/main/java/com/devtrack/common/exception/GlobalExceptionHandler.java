...
/**
 * The one place HTTP status codes get decided — see /docs/07_Backend_Architecture.md
 * §4 and /docs/06_API_Specification.md §1.4. No controller hand-rolls a status code.
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Catch-all for anything not in the hierarchy above — a genuine bug, not an
     * expected business condition. Never leaks a stack trace or internal detail to
     * the client (06_API_Specification.md §1.4) — logged with a correlation ID
     * instead, per 07_Backend_Architecture.md §7 (wired up when the correlation-ID
     * filter is added in the next slice).
     */

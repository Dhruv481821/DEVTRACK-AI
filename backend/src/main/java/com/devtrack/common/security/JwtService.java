...
/**
 * RS256 access-token issuance/validation — the decision and reasoning (asymmetric signing so a
 * future verifying service never needs the signing key) is in /docs/12_Security.md §2.2. Refresh
 * tokens are NOT JWTs — they're opaque random values, hashed at rest; see AuthService (next slice)
 * and /docs/05_Database_Architecture.md §7.
 */
@Service

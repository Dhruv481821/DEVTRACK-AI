...
/**
 * FR-GH-01. /connection is authenticated; /callback is deliberately NOT (see
 * SecurityConfig — must be added to the permitAll list) since GitHub redirects
 * the browser here with no DevTrack session attached, per GithubOAuthService's
 * docblock.
 */
@RestController
...
public class GithubController {
    ...
    public void callback(
        ...
        response.sendRedirect(
                emailProperties.frontend().baseUrl()

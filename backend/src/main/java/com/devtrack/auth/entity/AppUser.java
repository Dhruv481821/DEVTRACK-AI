 ...
 * /docs/17_Coding_Standards.md §2: explicit accessors, ID-only equality, no relationship fields in
 * toString (this entity has none yet, but the convention holds for every entity added later).
 */
@Entity
@Table(name = "app_user")
@Getter
...
public class AppUser {
  ...
  @Enumerated(
      EnumType
          .STRING) // never ORDINAL — reordering the enum later would silently corrupt stored data
